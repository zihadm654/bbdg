...
function index() {
  return (
    <>
      <CustomHead title="CLIENT SPACE | BBDG" />

      <Banner>
        <p className={BannerStyle.smallHeading}>
          TERMS OF USE <i className="fas fa-chevron-right"></i>{" "}
          <span className={BannerStyle.lowOpacity}>CLIENT SPACE</span>
        </p>
        ...
        <p className={BannerStyle.midHeading}>
          CONDITIONS TO USE CLIENT SPACE
        </p>
      </Banner>
