...
function index() {
  var Content = `
  <p><strong>Bajaj Global Business Development &amp; Consultancy Group (BBDG)<em> delivers a comprehensive access to all the BBDG information requests.</em></strong></p>
<p>Abstracts of <strong>Bajaj Global Business Development &amp; Consultancy Group (BBDG)</strong>&nbsp; Access to Report appeals are obtainable from the international and local Government's online portals.</p>
<p>All <strong>Bajaj Global Business Development &amp; Consultancy Group (BBDG)</strong>&nbsp; reports are readily available on the website of BBDG portal within 30 days of the previous month.</p>
<p>To obtain a report, or request access to the information, please contact:</p>
<p>____________</p>
<p>_____________</p>
<p>_____________</p>
<p><strong>Make a request form</strong></p>
<p><strong>Bajaj Global Business Development &amp; Consultancy Group (BBDG)</strong>&nbsp; <strong>experts</strong></p>
<p>The Information Experts disclose and provide summaries of <strong>Bajaj Global Business Development &amp; Consultancy Group (BBDG) </strong>investments, plans and reports. You can seek the aid of these experts for understanding more about <strong>Bajaj Global Business Development &amp; Consultancy Group</strong>, programs, projects, related news holdings, and acquisitions of particular information. Information</p>
<p>Our Expert aid access to information regarding Bajaj Global Business Development &amp; Consultancy Group (BBDG)&rsquo;s projects and provides support to individuals with practising their rights under the Access to Information Act, the relevant international laws or citizen Privacy Act.</p>
  ` 
  return (
    <>
    <CustomHead title="Transparency" />
      <Banner>
        <p className={BannerStyle.smallHeading}>
          <span className={BannerStyle.lowOpacity}>Transparency</span>
        </p>
        <p className={BannerStyle.BigHeading}>TRANSPARENCY</p>
        <br></br>
        <br></br>
