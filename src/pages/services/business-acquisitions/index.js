...
import style from "../financing/small_business_loans.module.css";
...
function BusinessAcquistions() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Business Acquistions | BBDG</title>
      </Helmet>
      <Banner>
        <p className={BannerStyle.smallHeading}>
          SERVICES <i className="fas fa-chevron-right"></i> Business Acquistions{" "}
          <i className="fas fa-chevron-right"></i>{" "}
          <span className={BannerStyle.lowOpacity}>BUSINESS ACQUISTIONS </span>{" "}
        </p>

        <p className={BannerStyle.BigHeading}>
          BUSINESS <br></br> ACQUISTIONS{" "}
        </p>
        <p className={BannerStyle.midHeading}>
          <br></br>BAJAJ GLOBAL BUSINESS DEVELOPMENT CONSULTANCY GROUP (BBDG)
          BUSINESS ACQUISITION BAJAJ GLOBAL BUSINESS DEVELOPMENT CONSULTANCY
          GROUP (BBDG) BRINGS ADVANCED SOLUTIONS TO ENSURE THAT YOU CAN{" "}
          <br></br>
          <br></br>{" "}
        </p>
      </Banner>
...
export default BusinessAcquistions;
