...
function Index() {
  ...
  return (
    <>
      <Helmet>
        <title>Industries | BBDG</title>
      </Helmet>
      <Banner>
        <p className={BannerStyle.smallHeading}>
          SERVICES <i className="fas fa-chevron-right"></i> INDUSTRIES{" "}
          <i className="fas fa-chevron-right"></i>{" "}
          <span className={BannerStyle.lowOpacity}>INDUSTRIES </span>{" "}
        </p>

        <p className={BannerStyle.BigHeading}>INDUSTRIES </p>
        <p className={BannerStyle.midHeading}>
          <br></br>BAJAJ GLOBAL BUSINESS DEVELOPMENT CONSULTANCY GROUP (BBDG)
          PORTFOLIO BAJAJ GLOBAL BUS... <br></br>
          <br></br>{" "}
        </p>
