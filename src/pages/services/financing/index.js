    ...
    <>
      ...
      <Banner>
        <p className={BannerStyle.smallHeading}>
          ...
          <span className={BannerStyle.lowOpacity}>FINANCING </span>{" "}
        </p>

        <p className={BannerStyle.BigHeading}>FINANCING </p>
        <p className={BannerStyle.midHeading}>
          <br></br>BAJAJ GLOBAL BUSINESS DEVELOPMENT CONSULTANCY GROUP (BBDG)
          FINANCING FOR ENTREPRENEURS BUSINESS LOANS FOR THOSE WITH LESS THAN 12
          MONTHS OF EXPERIENCE CHOOSE THE BEST FINANCING SERVICES <br></br>
          <br></br>{" "}
        </p>
      </Banner>
