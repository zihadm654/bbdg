    ...
    <>
      ...
      <Banner>
        ...
        <p className={BannerStyle.midHeading}>
          Welcome to Bajaj Global Business Development & Consultancy Group
          (BBDG)
        </p>
      </Banner>
