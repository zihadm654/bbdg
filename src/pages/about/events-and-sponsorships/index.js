      ...
      <Banner>
        <p className={BannerStyle.smallHeading}>
          ...
          <span className={BannerStyle.lowOpacity}>
            <i className="fas fa-chevron-right"></i> EVENTS AND SPONSORSHIPS{" "}
          </span>{" "}
        </p>
        <p className={BannerStyle.BigHeading}> EVENTS AND SPONSORSHIPS </p>
        <p className={BannerStyle.midHeading}>
          Bajaj Global Business Development & Consultancy Group (BBDG) regularly
          hosts events that recognise the contribution made by international
          businesses to the global economy and development.{" "}
        </p>
      </Banner>
