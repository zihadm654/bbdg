...
const Movement = () => {
    return (
        <>
            <CustomHead title=" MOVEMENT FOR SOCIETY’S BENEFITS | BBDG" />
            <Banner>
                <p className={BannerStyle.smallHeading}>ABOUT US <i className="fas fa-chevron-right"></i> WE’RE A B CORP  <span className={BannerStyle.lowOpacity}><i className="fas fa-chevron-right"></i> MOVEMENT FOR SOCIETY’S BENEFITS </span> </p>
                <p className={BannerStyle.BigHeading}>MOVEMENT
                FOR SOCIETY’S BENEFITS </p>
