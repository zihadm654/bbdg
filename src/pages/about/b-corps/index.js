...
function index(props) {
  ...
  return (
    <>
      <CustomHead title="WE’RE A B CORP | BBDG" />
      <Banner>
        ...
        <br />
        <p className={BannerStyle.midHeading}>Bajaj Global Business Development & Consultancy Group (BBDG) is a global movement of people who help boost companies and technologies. The aim is to attain and boost the outcomes for entrepreneurs</p>
      </Banner>
...
export async function getStaticProps() {
  const response = await axios.get(`${BaseApi}/about/all/b-corp`)
