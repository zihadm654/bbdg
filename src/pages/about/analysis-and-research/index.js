...
const index = (props) => {
    ...
    return (
        <>
            <CustomHead title=" ANALYSIS AND RESEARCH | BBDG" />
            <Banner>
                <p className={BannerStyle.smallHeading}>ABOUT US  <span className={BannerStyle.lowOpacity}><i className="fas fa-chevron-right"></i> ANALYSIS AND RESEARCH </span> </p>
                <p className={BannerStyle.BigHeading}>ANALYSIS <br></br> AND  <br></br> RESEARCH<br></br> </p>
                <p className={BannerStyle.midHeading}>WE RESEARCH ON ISSUES<br></br>
                    IMPACTING SMALL AND MEDIUM<br></br>SIZED BUSINESSES IN CANADA</p>
...
export async function getStaticProps() {
    const response = await axios.get(`${BaseApi}/about/all/analysis-and-research`)
