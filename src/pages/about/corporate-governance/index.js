...
const index = () => {
    ...
    return (
        <>
            <CustomHead title=" CORPORATE GOVERNANCE | BBDG" />
            <Banner>
                <p className={BannerStyle.smallHeading}>ABOUT US  <span className={BannerStyle.lowOpacity}><i className="fas fa-chevron-right"></i> CORPORATE GOVERNANCE  </span> </p>
                <p className={BannerStyle.BigHeading}> CORPORATE <br></br> GOVERNANCE </p>
                <p className={BannerStyle.midHeading}>Bajaj Global Business Development & Consultancy Group (BBDG) is governed by an independent board of directors that helps to ensure that the highest standards of quality and corporate governance practices are available. </p>
            </Banner>
